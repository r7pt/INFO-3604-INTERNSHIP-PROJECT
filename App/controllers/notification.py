...
def weeklyReport_received_notification(Student):
    ...
    weeklyReport_body_template = ("Dear" ,Student.full_name ,"\n this email is acknowledgement of your weekly report submission."
    try:
        Email.send_templated_email(Student.email,weeklyReport_subject_template,weeklyReport_body_template,context=None,body_html_template=None,attachments=None,cc=None,bcc=None,reply_to=None)
    except Exception as e:
        print("the following error has occurred ".e)

def accepted_student_received_notification(Company):
    accepted_student_subject_template="List of internship student Received"
    accepted_student_body_template = ("Dear" ,Company.company_name ,"\n this email is acknowledgement of your list of interested internship student."
    try:
        Email.send_templated_email(Company.email,accepted_student_subject_template,accepted_student_body_template,context=None,body_html_template=None,attachments=None,cc=None,bcc=None,reply_to=None)
    except Exception as e:
        print("the following error has occurred ".e)